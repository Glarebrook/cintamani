...
// 필드 전체 모양을 4:3으로 조정 - 기존(200x80, 가로로 긴 2.5:1 와이드 형태)이었던 걸,
// 실제로 뱀이 돌아다닐 수 있는 면적(PLAYABLE_MIN/MAX, 벽 두께를 뺀 안쪽)은 비슷하게 유지하면서
// 4:3 비율로 바꿨다 - 144x108(4:3 정확히 일치, 144=4*36, 108=3*36)에 벽 두께 10을 빼면
// 124x88=10912칸, 예전(180x60=10800칸)과 거의 같은 크기(+1% 이내).
export const GRID_W   = 144;     // 필드 가로 격자 수
export const GRID_H   = 108;     // 필드 세로 격자 수
...
export const BUILD_VERSION = '20260731-32';
